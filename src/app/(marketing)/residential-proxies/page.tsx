...
export const metadata: Metadata = { title: 'Residential Proxies' };

const pkg = PROXY_PACKAGES.residential;
    ...
    <main>
      <section className="bg-gradient-to-br from-brand-900 to-brand-700 py-16 text-white">
        <Container>
          ...
          <h1 className="mt-2 text-4xl font-bold">Residential Proxies</h1>
